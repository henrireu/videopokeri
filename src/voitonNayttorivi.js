export default function VoitonNaytto(pokerikasi, tila, panos, tuplausvalinta, voittosumma, tuplataanko) {
    if (tila === true) {
        let palautus = "ei voittoa";
        if (tuplataanko === true) {
            let summa = voittosumma.toFixed(1);
            palautus = "Voittosumma: " + parseFloat(summa).toFixed(2) + "$";
        } else {
